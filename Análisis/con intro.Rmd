...
Calcule la estimacion puntual del *ingreso promedio*, *proporcion de hogares pobres* y *total de personas*,a nivel de toda la población.
...
colnames(estimadores) <- c("Estimadores")


#Ingreso promedio

ingreso_promedo_gorro = as.data.frame(svymean(~ingreso_hog,ps_pps,deff=T))

ingreso_promedo_gorro$mean

confint(svymean(~ingreso_hog,ps_pps,deff=T))
