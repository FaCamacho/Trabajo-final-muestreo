...
jkn=as.svrepdesign(design=ps_pps,type='JKn', replicate=100)
...
tibble(est= te_boot$replicates) %>% ggplot()+
                                    ...
                                    theme_bw()+
                                    geom_vline(aes(xintercept=mean(te_boot$replicates)), color="blue", linetype="dashed", size=1) +
                                    geom_vline(aes(xintercept=median(te_boot$replicates)), color="red", linetype="dotted", size=1) +
                                    labs(title="Histograma con Media y Mediana",
                                        x="Ratios con de bootstrap",
                                        y="Frecuencia",
                                        caption="Media: 1727.804  Mediana: 1728.419") +
                                    theme(plot.title = element_text(hjust = 0.5))

#median(te_boot$replicates)-mean(te_boot$replicates)
