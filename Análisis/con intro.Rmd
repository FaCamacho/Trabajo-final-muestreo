...
Observando los coeficientes de variación se puede ver que son todos bajos excepto el de total de personas, que es un valor bastante alto e inusual, esto se podría deber a la presencia de datos atípicos muy grandes, a un error en la recolección de datos u otras opciones. De igual forma a este valor tan grande de CV lo interpretamos como que los datos son muy dispersos con respecto a la media.
...
Por último, se obtiene el deff para cada estimación, estos a diferencia de lo que se esperaba dieron mayores a uno, indicando que el diseño que aplicado es menos eficiente que el MAS, de igual forma, esto se podría deber a algún error en los calculos, debido a que al realizar las comparaciones con los verdaderos valores de los parámetros, estas fueron bastante buenas. Y como ya se conoce, el MAS no es de los mejores diseños.
