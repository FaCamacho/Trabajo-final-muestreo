...
ggplot(data, aes(x = Pobre, y = Cantidad_personas, fill = Estrategia)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  labs(title = "Gráfico de barras agrupadas por categoría y estrategia",
       x = "Categoría",
       y = "Cantidad de Personas")+
  scale_fill_manual(values = c("1000 réplicas" = "palegreen", "2000 réplicas" = "plum2", "Postestratificacion" = "lightskyblue1")) +
  theme_minimal()
```
